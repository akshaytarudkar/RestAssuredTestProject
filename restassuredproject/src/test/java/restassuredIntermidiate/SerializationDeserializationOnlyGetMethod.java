...
public class SerializationDeserializationOnlyGetMethod {
	...
	public void Serialization_Deserialization() throws JsonProcessingException {
		...
		SerializationDeserializationOnlyGetMethod objpojo = new SerializationDeserializationOnlyGetMethod();
		...
		SerializationDeserializationOnlyGetMethod objpojo2 = objectMapper.readValue(objpojoJson, SerializationDeserializationOnlyGetMethod.class);
